...
var (
	unknownCoder defaultCoder = defaultCoder{1, http.StatusInternalServerError, "An internal server error occurred", "http://opsdata.cn/elmt/pkg/errors/README.md"}
)
...
func MustRegister(coder Coder) {
	if coder.Code() == 0 {
		panic("code '0' is reserved by 'opsdata.cn/elmt/pkg/errors' as ErrUnknown error code")
	}
